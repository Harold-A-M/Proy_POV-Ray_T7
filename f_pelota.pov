...
#declare funcion_altura=function(alt){sin(pi*alt)+0.7};  

#declare altura=funcion_altura(clock);

#declare altura_pt=funcion_altura(clock)-0.6;
